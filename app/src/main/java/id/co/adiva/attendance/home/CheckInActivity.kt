...
class CheckInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tittle.text = "Absen Masuk"

        binding.back.setOnClickListener(View.OnClickListener { onBackPressed() })

        binding.sharelok.setOnClickListener {
            Toast.makeText(this@CheckInActivity, "Masukan foto absen terlebih dahulu", Toast.LENGTH_LONG).show()
        }
                ...
                thread {
                    try {
                        ...
                        val request = Request.Builder()
                            .url("${HPI.API_URL}attendance/clock-in")
                            .post(requestBody)
                            .build()
